...
const PHASES = [
  { id: 1, name: 'Series Bible Generation', desc: 'Grok 3 generates characters, venues & episode outlines' },
  ...
  { id: 6, name: 'Video Generation', desc: 'Generating all 80 clips via Grok Imagine Video (Kie.ai)' },
...
export default function Progress({ id }: { id: string }) {
  ...
  const runWorkflow = async (form: UniversePrompt) => {
    try {
      ...
      setPhase(0, 'running', 'Calling Grok 3 to generate series bible…')
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-[260px,1fr] gap-8">
        {/* Phase list */}
        ...
        <div className="space-y-6 min-w-0">
          ...
          {/* Complete card */}
          {isComplete && (
            <div className="bg-green-950/20 border border-green-900/60 rounded-xl p-6 text-center">
              <p className="text-4xl font-bold text-green-400 mb-2">Series Complete</p>
              <p className="text-zinc-400 text-sm mb-6">
                All {bible?.episodes.length} episodes generated successfully.
              </p>
              <button
                onClick={() => router.push('/')}
                className="bg-zinc-800 hover:bg-zinc-700 text-zinc-300 px-6 py-2.5 rounded-lg font-medium transition-colors text-sm"
              >
              ...
              <div className="space-y-2 max-h-48 overflow-y-auto pr-2">
                ...
                {scripts.length > 5 && (
                  <p className="text-xs text-zinc-600 font-mono">
                    + {scripts.length - 5} more episodes…
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl p-6">
              ...
              <p className="text-3xl font-bold text-white">
                ...
                <span className="text-zinc-600 text-lg font-normal ml-2">
                  / {(formData?.total_episodes ?? 20) * 4} clips
                </span>
              </p>
            </div>
          )}
