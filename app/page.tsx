        ...
        <form onSubmit={handleSubmit} className="pb-24 space-y-6">
          ...
          <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input
                  ...
                  onChange={set('series_title')}
                  placeholder="The Last Name on the Will"
              ...
              <div>
                ...
                <input
                  value={form.genre}
                  onChange={set('genre')}
                  placeholder="Melodrama / Micro-drama"
                  className={inputClass}
                  required
                />
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input
                  ...
                  onChange={set('setting_era')}
                  placeholder="Contemporary Malaysia, 2024"
                  className={inputClass}
                />
              </div>
              <div>
                ...
                <input
                  value={form.tone}
                  onChange={set('tone')}
                  placeholder="Tense, emotional, cinematic"
                  className={inputClass}
                />
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                onChange={set('core_conflict')}
                placeholder="A dying tycoon's hidden will tears a family apart"
                rows={3}
          ...
          <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl p-6">
            <div className="mb-4">
              ...
              <p className="text-sm text-zinc-600 mt-1">
                The structural and emotional mechanics applied to every episode. Swap formulas to change the narrative engine without altering the story world.
              </p>
            </div>

            <div className="mb-3 flex flex-wrap gap-2">
              <span className="font-mono text-[11px] px-2 py-1 bg-zinc-800/60 border border-zinc-700 rounded text-zinc-500">
                Step 1 → Clip 1 (0–15s)
              </span>
              <span className="font-mono text-[11px] px-2 py-1 bg-zinc-800/60 border border-zinc-700 rounded text-zinc-500">
                Step 2 → Clip 2 (15–30s)
              </span>
              <span className="font-mono text-[11px] px-2 py-1 bg-zinc-800/60 border border-zinc-700 rounded text-zinc-500">
                Step 3 → Clip 3 (30–45s)
              </span>
              <span className="font-mono text-[11px] px-2 py-1 bg-zinc-800/60 border border-zinc-700 rounded text-zinc-500">
                Step 4 → Clip 4 (45–60s)
              </span>
            </div>
          ...
          {/* Section 03 — Production Settings */}
          <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl p-6">
            <p className="font-mono text-[11px] tracking-widest uppercase text-zinc-500 mb-5">
            ...
            <p className="text-[11px] text-zinc-600 font-mono text-center">
              4 clips × 15s per episode · 9:16 · 720p · ~17s generation per clip · ~{Math.round(clips * 17 / 60)}min total
            </p>
          </div>
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-red-700 hover:bg-red-600 disabled:bg-zinc-700 disabled:cursor-not-allowed text-white font-semibold py-4 rounded-xl text-base transition-colors flex items-center justify-center gap-2"
          >
            {submitting ? (
              <>
